...
import os
import numpy as np
from imdb import Imdb # Base class for dataset loading
    ...
    def __init__(self, image_set, year, devkit_path, shuffle=False, is_train=False, class_names=None,
        ...
        if class_names is not None:
            ...
            self.classes = self._load_class_names(names, 
                "/home/ly/mxnet/example/ly/SSD-gulon/datasets/VOC0712") # (filename, dirname).
            # default class_names is None, so there needs a class file, which is the label_map.txt
            # in caffe-ssd. There are 21 classes, the first class is background.
            # label form 0 to 20.
